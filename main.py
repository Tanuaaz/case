...
def main():
    ...
    triangle(-90,80, 120, '#dc143c', 315)
    triangle(-92, -92, 120, '#fefe22', 45)
    triangle(82, 78, 60, '#8b00ff', 225)
    square(38, -48, 57, '#ff9900', 90)
    triangle(-1, -94, 83, '#6ab8e3', 0)
    parallelogram(-87, -94, 61, 80, '#9acd32', 180)
    triangle(33, -48, 53, '#de71e2', 135)
